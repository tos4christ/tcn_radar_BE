const tickets = {
    ...
    update_ticket: 'UPDATE tickets_table SET station=$1, equipment=$2, comment=$3, priority=$4 where disco=$5 and id=$6',
    update_appr_1: 'UPDATE tickets_table SET appr_one=$1, status=$2 where disco=$3 and id=$4',
    update_appr_2: 'UPDATE tickets_table SET appr_two=$1, status=$2 where disco=$3 and id=$4',
