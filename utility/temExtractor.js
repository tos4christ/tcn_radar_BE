                ...
                if (equipment_to_sum.length > 0) {
                    equipment_to_sum.forEach((equip, index) => {
                        ...
                        if(index == 0 && temp_hold.length == 0) {
                            ...
                            equip[key].forEach( (e) => {
                                temp_hold.push({date: e.date, hour: e.hour, minute: e.minute, kv: e.kv, mw: Math.abs(e.mw), mvar: Math.abs(e.mvar), amp: Math.abs(e.amp), station: 'AFAM IV & V (GAS)'})                                
                            })
                        } else {
                ...
                if (equipment_to_sum.length > 0) {
                    equipment_to_sum.forEach((equip, index) => {
                        ...
                        if(index == 0 && temp_hold.length == 0) {
                            ...
                            // for the station for this day, any time not here will not be accepted
                            equip[key].forEach( (e) => {
                                temp_hold.push({date: e.date, hour: e.hour, minute: e.minute, kv: e.kv, mw: Math.abs(e.mw), mvar: Math.abs(e.mvar), amp: Math.abs(e.amp), station: 'SHIRORO (HYDRO)'})                                
                            })
                        } else {
                            // Get the key for the next elements
                            const key = Object.keys(equip)[0];
                ...
                if (equipment_to_sum.length > 0) {
                    equipment_to_sum.forEach((equip, index) => {
                        ...
                        if(index == 0 && temp_hold.length == 0) {
                            ...
                            // for the station for this day, any time not here will not be accepted
                            equip[key].forEach( (e) => {
                                temp_hold.push({date: e.date, hour: e.hour, minute: e.minute, kv: e.kv, mw: Math.abs(e.mw), mvar: Math.abs(e.mvar), amp: Math.abs(e.amp), station: 'TAOPEX GS'})                                
                            })
                        } else {
                            // Get the key for the next elements
                            const key = Object.keys(equip)[0];
                ...
                if (equipment_to_sum.length > 0) {
                    equipment_to_sum.forEach((equip, index) => {
                        ...
                        if(index == 0 && temp_hold.length == 0) {
                            ...
                            // for the station for this day, any time not here will not be accepted
                            equip[key].forEach( (e) => {
                                temp_hold.push({date: e.date, hour: e.hour, minute: e.minute, kv: e.kv, mw: Math.abs(e.mw), mvar: Math.abs(e.mvar), amp: Math.abs(e.amp), station: 'EGBIN (STEAM)'})                                
                            })
                        } else {
                            // Get the key for the next elements
                            const key = Object.keys(equip)[0];
                ...
                if (equipment_to_sum.length > 0) {
                    equipment_to_sum.forEach((equip, index) => {
                        ...
                        if(index == 0 && temp_hold.length == 0) {
                            ...
                            // for the station for this day, any time not here will not be accepted
                            equip[key].forEach( (e) => {
                                temp_hold.push({date: e.date, hour: e.hour, minute: e.minute, kv: e.kv, mw: Math.abs(e.mw), mvar: Math.abs(e.mvar), amp: Math.abs(e.amp), station: 'KAINJI (HYDRO)'})                                
                            })
                        } else {
                            // Get the key for the next elements
                            const key = Object.keys(equip)[0];
                ...
                if (equipment_to_sum.length > 0) { 
                    equipment_to_sum.forEach((equip, index) => {
                        ...
                        if(index == 0 && temp_hold.length == 0) {
                            ...
                            // for the station for this day, any time not here will not be accepted
                            equip[key].forEach( (e) => {
                                temp_hold.push({date: e.date, hour: e.hour, minute: e.minute, kv: e.kv, mw: e.mw, mvar: e.mvar, amp: e.amp, station: 'ALAOJI NIPP (GAS)'})                                
                            })
                        } else {
                            // Get the key for the next elements
                            const key = Object.keys(equip)[0];
